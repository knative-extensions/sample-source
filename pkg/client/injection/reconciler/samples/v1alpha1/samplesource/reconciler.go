...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SampleSource, desiredFinalizers sets.String) (*v1alpha1.SampleSource, error) {
	// Don't modify the informers copy.
